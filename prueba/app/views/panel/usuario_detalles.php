                                            ...
                                            <center>
                                                <?php
                                                    if (file_exists('../../../recursos/img/users/'.$usuario->imagen_usuario)) {
                                                        ...
                                                        $img = ($usuario->sexo_usuario == 1) ?  '../../../recursos/img/users/man.png': '../../../recursos/img/users/woman.png' ;
                                                    }//end else
                                                ?>
                                                <img src="<?php echo $img; ?>" class="img-rounded" alt="" id="img-preview" width="20%">
                                            </center>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <div class="form-check">
                                                    <input class="form-check-input" type="radio" name="sexo" value="0" <?= $usuario->sexo_usuario == 0 ? 'checked' : '' ?>>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="rol">
                                                    ...
                                                    <option value="749" <?= $usuario->id_rol == 749 ? 'selected' : '' ?>>Administrador</option>
                                                    <option value="249" <?= $usuario->id_rol == 249 ? 'selected' : '' ?>>Manager</option>
                                                    <option value="379s" <?= $usuario->id_rol == 379 ? 'selected' : '' ?>>Artista</option>
                                                    <option value="599" <?= $usuario->id_rol == 599 ? 'selected' : '' ?>>Audiencia</option>
                                                </select>
                                            </div>
                                        </div>
